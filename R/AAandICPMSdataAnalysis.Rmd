...
QC_compTable <- merge(Buffalo_Table, ICPMS_QC_data)
QC_compTable
#Percent error
...
QC_compTable$metal
QC_PDcompTable <- data.frame(QC_compTable$metal, Percent_error, Difference)
QC_PDcompTable

#Cd111
#subset(ICPMS_QC_data_notAv, metals_analyzed == "Cd111")
#t.test(2378.705,2.94, mu= 3)
```
